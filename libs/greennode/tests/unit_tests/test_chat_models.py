...
def test_greennode_model_param() -> None:
    llm = ChatGreenNode(model="foo")
    assert llm.model_name == "foo"
    llm = ChatGreenNode(model_name="foo")  # type: ignore[call-arg]
    assert llm.model_name == "foo"
    ls_params = llm._get_ls_params()
    assert ls_params["ls_provider"] == "greennode"
